...
// TODO: Reuse CustomTextField internally here
  ...
  OutlineInputBorder customInputBorder(bool focused) {
    return OutlineInputBorder(
      ...
      borderSide: BorderSide(
        color: focused ? AppColors.greenn : AppColors.grey,
        width: focused ? 2 : 1,
      ),
    );
  }
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          if (showIconOutsideField) SizedBox(width: 10),
          Expanded(
            child:
                widget.textField != null
                    ...
                    : TextFormField(
                      ...
                      style: TextStyle(
                        ...
                        //     ? CustomFontSizes.medium
                        //     : CustomFontSizes.small
                      ),
                      decoration: InputDecoration(
                        ...
                        prefixIcon:
                            (widget.icon != null && !showIconOutsideField)
                                ? Icon(widget.icon)
                                : null,
                        ...
                        border:
                            widget.type == CustomTextFormFieldType.outlined
                                ? OutlineInputBorder()
                                : widget.type ==
                                    CustomTextFormFieldType.underline
                        ...
                        errorBorder:
                            widget.type == CustomTextFormFieldType.outlined
                                ...
                                : InputBorder.none,
                        suffixIcon:
                            widget.showClearIcon && _controller.text != ''
                                ? IconButton(
                      ...
                      autovalidateMode:
                          widget.activeOnUserInteraction
